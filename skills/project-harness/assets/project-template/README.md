...
2. Use `New requirement: ...` in the product conversation to clarify work.
3. Use `Requirement discussion is done. Please dispatch tasks.` to create task instructions.
4. Use `Issue: ...` in the most relevant conversation; it will either handle or escalate the issue.
